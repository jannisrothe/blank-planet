...
import { render, space } from './config.js';
...
export function createWorld() {
  ...
  renderer.setClearColor(space.background, 1);
  ...
  // Far enough to keep the sky shell inside the frustum as well as the planet.
  const far = space.radius * 1.6;
